...
import styles from "./OTPForgetPassword.module.css";
...
const OTPForgetPassword = () => {
  ...
  const handleVerify = async (code) => {
    ...
    try {
      ...
      if (code === "1234") {
        setSuccess(true);
        console.log("OTP verified successfully for password reset:", code);
        // هنا يمكن إعادة التوجيه لصفحة إعادة تعيين كلمة المرور
        alert(
          t("otp_verified_success") ||
            "تم التحقق من الكود بنجاح! يمكنك الآن إعادة تعيين كلمة المرور"
        );
            ...
            <div className={styles.otpWrapper}>
              ...
              <div className={styles.otpHeader}>
                ...
                <h2 className={styles.otpTitle}>
                  {t("verify_reset_code") || "تحقق من كود إعادة التعيين"}
                </h2>
                <p className={styles.otpSubtitle}>
                  {t("otp_forgot_subtitle") ||
                    "أدخل الكود المرسل إلى رقم هاتفك لإعادة تعيين كلمة المرور"}
                </p>
              </div>
              ...
              <div className={styles.otpForm}>
                ...
                <div className={styles.backToLogin}>
                  <span className={styles.backToLoginText}>
